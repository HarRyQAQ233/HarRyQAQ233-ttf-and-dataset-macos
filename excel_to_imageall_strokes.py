...
for z in lines:
    ...
    os.makedirs("/Users/xiaomo/PycharmProjects/datause/imageall-strokes/28/" + str(k), exist_ok=True)
    ...
    cv2.imwrite("/Users/xiaomo/PycharmProjects/datause/imageall-strokes/28/" + str(k) + "/" + str(h) + ".png", imgall1)  # 保存汉字完整图像
    print(z)
