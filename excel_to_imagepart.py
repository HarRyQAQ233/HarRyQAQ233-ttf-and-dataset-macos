...
for z in lines:
    ...
    os.makedirs("/Users/xiaomo/PycharmProjects/datause/imagepart/28/", exist_ok=True)
    ...
    for i in range(0, nrows):
        if sheet1_content1.cell(i, 0).value == 9999:
            ...
            cv2.imwrite("/Users/xiaomo/PycharmProjects/datause/imagepart/28/" + str(h) + '-' + str(k + 1) + '.png', img1)
